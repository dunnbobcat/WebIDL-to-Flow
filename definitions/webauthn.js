...
type ClientCapability = 'conditionalCreate' | 'conditionalGet' | 'hybridTransport' | 'passkeyPlatformAuthenticator' | 'userVerifyingPlatformAuthenticator' | 'relatedOrigins' | 'signalAllAcceptedCredentials' | 'signalCurrentUserDetails' | 'signalUnknownCredential';
...
declare class AuthenticatorAssertionResponse extends AuthenticatorResponse {+authenticatorData: ArrayBuffer;
+signature: ArrayBuffer;
+userHandle: ArrayBuffer | null;
}

declare class AuthenticatorAttestationResponse extends AuthenticatorResponse {+attestationObject: ArrayBuffer;
...
declare class AuthenticatorResponse {+clientDataJSON: ArrayBuffer;
}

declare class PublicKeyCredential extends Credential {+authenticatorAttachment: string | null;
+rawId: ArrayBuffer;
...
static parseRequestOptionsFromJSON(options: PublicKeyCredentialRequestOptionsJSON): PublicKeyCredentialRequestOptions;
static signalAllAcceptedCredentials(options: AllAcceptedCredentialsOptions): void;
...
/* partial */ interface PublicKeyCredential {static isUserVerifyingPlatformAuthenticatorAvailable(): boolean;
}

/* partial */ interface PublicKeyCredential {static getClientCapabilities(): PublicKeyCredentialClientCapabilities;
}

/* partial */ interface PublicKeyCredential {static parseCreationOptionsFromJSON(options: PublicKeyCredentialCreationOptionsJSON): PublicKeyCredentialCreationOptions;
}

/* partial */ interface PublicKeyCredential {static parseRequestOptionsFromJSON(options: PublicKeyCredentialRequestOptionsJSON): PublicKeyCredentialRequestOptions;
}

/* partial */ interface PublicKeyCredential {static signalAllAcceptedCredentials(options: AllAcceptedCredentialsOptions): void;
static signalCurrentUserDetails(options: CurrentUserDetailsOptions): void;
static signalUnknownCredential(options: UnknownCredentialOptions): void;
}
