declare class CSSFontFaceDescriptors extends CSSStyleDeclaration {ascent-override: string;
...
declare class CSSFontFaceRule extends CSSRule {+style: CSSFontFaceDescriptors;
}
