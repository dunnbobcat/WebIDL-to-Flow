...
/* partial */ declare namespace CSS {declare +layoutWorklet: Worklet;
}

declare class BreakToken {+childBreakTokens: ChildBreakToken;
+data: any;
}

declare class ChildBreakToken {+breakType: BreakType;
+child: LayoutChild;
}

declare class FragmentResult {+blockSize: number;
+inlineSize: number;

constructor(options?: FragmentResultOptions): void;
}

declare class IntrinsicSizes {+maxContentSize: number;
+minContentSize: number;
}

declare class LayoutChild {+styleMap: StylePropertyMapReadOnly;

intrinsicSizes(): IntrinsicSizes;
layoutNextFragment(constraints: LayoutConstraintsOptions, breakToken: ChildBreakToken): LayoutFragment;
}

declare class LayoutConstraints {+availableBlockSize: number;
+availableInlineSize: number;
...
declare class LayoutEdges {+block: number;
+blockEnd: number;
+blockStart: number;
+inline: number;
+inlineEnd: number;
...
declare class LayoutFragment {blockOffset: number;
+blockSize: number;
...
declare class LayoutWorkletGlobalScope extends WorkletGlobalScope {registerLayout(name: string, layoutCtor: VoidFunction): void;
}
